    ...
    <div class="mt-4 flex">
        <span class="relative z-0 inline-flex shadow-sm">
            <button type="button"  
                    ...
                    :content="$t('first')" v-tippy='{ placement : "top", arrow : true }'
            ...
            <button type="button" 
                    ...
                    :content="$t('previous')" v-tippy='{ placement : "top", arrow : true }'
                    :class="{ 'cursor-not-allowed bg-gray-300': pagination.current_page <= 1 }" 
                    class="-ml-px relative inline-flex items-center px-2 py-3 border border-gray-300 bg-white text-sm leading-5 font-medium text-gray-500 hover:text-gray-400 focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-500 transition ease-in-out duration-150">
            ...
            <button type="button" 
                    ...
                    class="-ml-px relative inline-flex items-center px-2 sm:px-4 md:px-4 lg:px-4 py-3 border border-gray-300 bg-white text-sm leading-5 font-medium focus:z-10 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                <span x-text="page.name">{{ page }}</span>
            </button>

            <button type="button" 
                    @click.prevent="changePage(pagination.current_page + 1)"
                    :content="$t('next')" v-tippy='{ placement : "top", arrow : true }'
            ...
            <button type="button" 
                    ...
                    :content="$t('last')" v-tippy='{ placement : "top", arrow : true }'
                    :class="{ 'cursor-not-allowed bg-gray-300': pagination.current_page >= pagination.last_page }" 
